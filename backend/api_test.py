...
nikhil
 added 
Madhu4
 to the group. — Yesterday at 9:45 PM
nikhil
 added 
esha
 to the group. — Yesterday at 9:47 PM
nikhil — 10:47 AM
Space Debris Risk Intelligence Platform
The pitch: there are 27,000+ tracked debris objects in orbit and hundreds of thousands untracked. Collision avoidance decisions today are made with fragmented, hard-to-access data. You build the unified intelligence layer.
What it does:

Pulls live TLE (Two-Line Element) orbital data from Space-Track.org (free, open API)
Ingests NASA/ESA conjunction warning feeds
Runs collision probability modeling and trajectory forecasting
Databricks lakehouse as the data backbone (free credits, sponsor prize locked)
Clean dashboard showing real-time debris risk zones, satellite vulnerability scoring, and alert prioritization

Why it wins specifically:

Space Coast judges will feel this in their bones. These people work with or near people whose satellites are actually at risk
Databricks integration almost guarantees sponsor recognition
The demo is visually stunning, orbital paths and risk heatmaps on a globe
Data is all public and accessible, no hardware, no blocked APIs
Screams viability: SpaceX, L3Harris, Lockheed all have Space Coast presence and are obvious customers
Nobody else is building this

Team split:

1 data pipeline + Databricks integration
1 orbital mechanics + collision probability model
1 frontend (3D globe visualization, Three.js or CesiumJS)
1 AI layer (anomaly detection, risk scoring, natural language alerts)
1 pitch + demo narrative + business case

This is the one. Thoughts?
@everyone
PermaMeme — 10:57 AM
Attachment file type: document
orbital_shield_product_spec.docx
15.36 KB
PermaMeme — 11:17 AM
Image
PermaMeme — 11:39 AM
esha — 11:39 AM
https://docs.google.com/document/d/1WW4H4cAarKYQzjeONrz4Hw3chYQ0w97ic5eiznLfxLY/edit?usp=sharing
Google Docs
SCI Drift-Zero
Image
nikhil — 11:59 AM
Attachment file type: acrobat
drift_zero_spec_v4.pdf
12.75 KB
PermaMeme — 1:16 PM
{
  "_meta": {
